...
function App() {
  ...
  return (
    <>
      ...
      {/* Created by credit */}
      <div className="fixed bottom-4 left-4 text-white text-xs font-medium tracking-wide" style={{ zIndex: 9999 }}>
        Created by <span className="font-semibold">Kritartha Pandey</span>
      </div>
    </>
  );
}
